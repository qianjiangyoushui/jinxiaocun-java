 ...
 * 
 * @date 2017-08-25 16:45
 * @filename Eppo.java
 * 
 */
 
public class Eppo implements java.io.Serializable{
    ...
    private String squaredose;
    
    private String squarunit;
    ...
    public String getSquaredose() {
        return squaredose;
    }

    public void setSquaredose(String squaredose) {
        this.squaredose = squaredose;
    }
    public String getSquarunit() {
        return squarunit;
    }

    public void setSquarunit(String squarunit) {
        this.squarunit = squarunit;
    }
