...
<body style="background-color: #FFFFFF">
	<div style="height: 50px; line-height: 50px; background: #f7f7f7; text-align: center; font-size: 16px; border-bottom: 1px solid #bdbbbc; position: relative">
		...
		<a href="javascript:;" style="position: absolute; right: 13px; top: 15px; text-decoration: none; font-size: 12px; color: #333">保存</a>
	</div>
	...
	<form action="${wechatPath}wintertest/save.action" method="post">
		<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="描述" name="description" id="description" style="margin-top: 5px;margin-bottom: 5px;" value="${lookimage.description}">
				</div>							
			</div>
	...
	var pb1 = $.photoBrowser({
        items: [
			<c:forEach items="${lookimage.upimage}" var="image">
				"${image.url}",
			</c:forEach>
        ],
