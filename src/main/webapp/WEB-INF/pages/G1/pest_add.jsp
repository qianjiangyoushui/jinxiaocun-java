		...
		<div class="weui-cells weui-cells_form" style="margin-top: 0px;">
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="请选择日期" name="happendate" id="happendate" style="margin-top: 5px;margin-bottom: 5px">
				</div>
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="请输入病虫害种类" name="pesttype" id="pesttype" style="margin-top: 5px;margin-bottom: 5px;">
				</div>							
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="请输入位置编号" name="placecode" id="placecode" style="margin-top: 5px;margin-bottom: 5px;">
				</div>							
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="请输入发生率，小数或整数" name="probability" id="probability" style="margin-top: 5px;margin-bottom: 5px;">
				</div>							
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="请输入调查人" name="principal" id="principal" style="margin-top: 5px;margin-bottom: 5px;">
				</div>							
			</div>
