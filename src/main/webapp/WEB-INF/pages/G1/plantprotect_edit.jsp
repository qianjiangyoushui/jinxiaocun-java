...
<body>
	...
	<input class="weui-input" type="hidden" name="guid" id="guid" style="margin-top: 5px;margin-bottom: 5px;width:110px;" value="${plantprotect.guid}" readonly="readonly">
		<div class="weui-cells weui-cells_form" style="margin-top: 0px;">
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="请选择日期" name="dodate" id="dodate" style="margin-top: 5px;margin-bottom: 5px" value="${plantprotect.dodate}">
				</div>
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="请输入用途" name="usetype" id="usetype" style="margin-top: 5px;margin-bottom: 5px;" value="${plantprotect.usetype}">
				</div>							
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="请输入用药种类" name="drugkind" id="drugkind" style="margin-top: 5px;margin-bottom: 5px;" value="${plantprotect.drugkind}">
				</div>							
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="请输入亩用药量" name="drugdose" id="drugdose" style="margin-top: 5px;margin-bottom: 5px; width:110px" value="${plantprotect.drugdose}">
					<input class="weui-input" type="text" placeholder="单位" name="drugdoseunit" id="drugdoseunit" style="margin-top: 5px;margin-bottom: 5px;width:110px" value="${plantprotect.drugdoseunit}">
				</div>							
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="请输入亩用水量" name="waterdose" id="waterdose" style="margin-top: 5px;margin-bottom: 5px;" value="${plantprotect.waterdose}">
				</div>							
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="请输入用药方式" name="drugusetype" id="drugusetype" style="margin-top: 5px;margin-bottom: 5px;" value="${plantprotect.drugusetype}">
				</div>							
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" name="startdate" id="startdate" style="margin-top: 5px;margin-bottom: 5px; width:110px" value="${plantprotect.startdate}">
					<input class="weui-input" type="text" name="enddate" id="enddate" style="margin-top: 5px;margin-bottom: 5px; width:110px" value="${plantprotect.enddate}">
				</div>							
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" readonly="readonly" placeholder="请输入上传人" name="uploadperson" id="uploadperson" style="margin-top: 5px;margin-bottom: 5px;" value="${uploadperson}">
				</div>							
			</div>
	...
	function uploadimg(src,date,type,desc){
		...
		$(".submitid").on("click",function(){
			...
			if(drugdose==null||drugdose==""){
				$.toptip('请输入亩用药量', 'error');
				return false;
			}
			
			var drugdoseunit=$("#drugdoseunit").val().replace(/^\s+|\s+$/g,"");
			if(drugdoseunit==null||drugdoseunit==""){
				$.toptip('请输入亩用药量单位', 'error');
				return false;
			}
			
			var waterdose=$("#waterdose").val().replace(/^\s+|\s+$/g,"");
			if(waterdose==null||waterdose==""){
				$.toptip('请输入亩用水量', 'error');
				return false;
			}
			...
			//$("#formid").submit();
			$.ajax({
				url : "${wechatPath}plantprotect/save.action",
				type : "POST",
				async : false,
				dataType : 'json',
				data : {
				...
				success : function(data) {
					...
					if(data.msg=='ok'){
						$.confirm("修改成功", function() {
							window.location.href="${wechatPath}plantprotect/list.action?seedfileid="+seedfileid;
					  }, function() {
