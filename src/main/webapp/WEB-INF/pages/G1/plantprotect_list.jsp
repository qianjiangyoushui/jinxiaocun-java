	...
	$("#datetime-start").calendar();
	 $("#datetime-end").calendar();
		...
		function getdataPage(){
			...
			var id = '${plantprotect.seedfileid}';
			$.ajax({
			  url: "${wechatPath}plantprotect/pageList.action",
			  type:"POST",
			  async: true,
			  dataType: 'json',
			  ...
			  success: function(data){
				  ...
				  for(var i=0;i<rows.length;i++){
					 ...
					 content += '<div class="bd"><div> <a class="weui-cell weui-cell_access" href="${wechatPath}plantprotect/detail.action?guid='+rows[i].guid+'"><div class="weui-cell__bd">';
					 ...
					 content += '<span style="font-size: 12px;color: #666666">亩用药量：'+rows[i].drugdose+rows[i].drugdoseunit+'</span><br/>';
