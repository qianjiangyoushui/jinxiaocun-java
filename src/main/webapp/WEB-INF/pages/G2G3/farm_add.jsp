...
<body style="background-color: #FFFFFF">
	...
	<form action="${wechatPath}farm/save.action" method="post" id="formid">
		<div class="weui-cells weui-cells_form" style="margin-top: 0px;">
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="例如坡地农场" name="farmname" id="farmname" onkeyup="check();"
						style="margin-top: 5px; margin-bottom: 5px;"/>
				</div>
			</div>
			<div class="weui-cell">
				<div class="weui-cell__hd">
					<label class="weui-label">农场简码：</label>
				</div>
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="大写字母" name="farmcode" id="farmcode" onkeyup="checkcode();"
						style="margin-top: 5px; margin-bottom: 5px;"/>
				</div>
			</div>
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="number"  placeholder="租赁合同面积" name="leasearea"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="实际可耕种面积"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="沙土/黏土"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="坡地/平地"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="number" placeholder="年平均降雨量（毫米）"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="number" placeholder="年无霜期天数"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="number" placeholder="配置的变压器个数"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<textarea class="weui-textarea" name="transfordesc" id="transfordesc" placeholder="描述每个变压器的配置情况，如125kw一台 380kw两台" rows="3" style="margin-top: 5px; margin-bottom: 5px;border:solid 1px #E0E0E0; border-radius:10px; resize:none;"></textarea>
				</div>
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<textarea class="weui-textarea" name="mechanical" id="mechanical" placeholder="例如：拖拉机3台：John Deer（1354）1台、John Deer （1204）1台、John Deer（484）1台；马铃薯四行播种机1台 ；美诺打药机1台；Grimm双行收获机1台" rows="3" style="margin-top: 5px; margin-bottom: 5px;border:solid 1px #E0E0E0; border-radius:10px; resize:none;"></textarea>
				</div>
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<textarea class="weui-textarea" name="staffing" id="staffing" placeholder="农场员工配置" rows="3" style="margin-top: 5px; margin-bottom: 5px;border:solid 1px #E0E0E0; border-radius:10px; resize:none;"></textarea>
				</div>
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="number" placeholder="单位（米）"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="number" placeholder="PH值"
						name="ph" id="ph"
						style="margin-top: 5px; margin-bottom: 5px;"/>
				</div>
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="number" placeholder="合同开始年份"    name="leasestart" id="leasestart"style="margin-top: 5px;margin-bottom: 5px;width:110px;">
					<input class="weui-input" type="number"  placeholder="合同结束年份"  name="leaseend" id="leaseend" style="margin-top: 5px;margin-bottom: 5px;width:110px;"/>
				</div>
			</div>
	...
	<script type="text/javascript">
		 ...
		 function uploadimg(src,date,type,desc){
		  ...
		  $("#submitid").on("click",function(){
				...
				var transfordesc=$("#transfordesc").val();
				...
				$.ajax({
					url : "${wechatPath}farm/save.action",
					type : "POST",
					async : false,
					dataType : 'json',
					data : {
					...
					success : function(data) {
						...
						if(data.msg=='ok'){
							$.confirm("新增成功", function() {
								window.location.href="${wechatPath}farm/list.action?type=${type}";
						  }, function() {
