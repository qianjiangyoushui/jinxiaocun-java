		...
		<div class="weui-cells weui-cells_form" style="margin-top: 0px;">
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="例如：坡底一号圈" name="plotname" id="plotname" onkeyup="check();"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="大写字母数字" name="plotcode" id="plotcode" onkeyup="checkcode();"
						style="margin-top: 5px; margin-bottom: 5px;"/>
				</div>
			</div>
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text"  placeholder="喷灌/滴灌/旱地" name="irrigatetype"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="例如（林赛、伊尔）"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="有几口井"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<textarea class="weui-textarea" name="wellsdisc" id="wellsdisc" placeholder="描述机井详细信息比如：3口井（30米30吨、30米30吨、45米30吨）" rows="3" style="margin-top: 5px; margin-bottom: 5px;border:solid 1px #E0E0E0; border-radius:10px; resize:none;"></textarea>
				</div>
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="number" placeholder="单位KM"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="number" placeholder="与其他马铃薯、油菜作物的距离"
...
// 				  }
				  ...
				  var imageids = new Array(els.length);
				   ...
				   $.ajax({
						url : "${wechatPath}plot/save.action",
						type : "POST",
						async : false,
						dataType : 'json',
						data : {
							...
							plotname:plotname,
							plotcode:plotcode,
							irrigatetype:irrigatetype,
							irrigbrand:irrigbrand,
							wellsamount:wellsamount,
							wellsdisc:wellsdisc,
							distvillage:distvillage,
							distroad:distroad,
							distother:distother,
						...
						success : function(data) {
							if(data.msg=='ok'){
								$.confirm("新增成功", function() {
									window.location.href="${wechatPath}farm/detail.action?farmid=${farmid}&type=${type}&operate=${sessionScope.operate}";
							  }, function() {
								  window.location.href="${wechatPath}farm/detail.action?farmid=${farmid}&type=${type}&operate=${sessionScope.operate}";
							  });
							}
