			...
			<c:if test="${!empty seedfile.variety}">
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" type="text" placeholder="${seedfile.varietys.belongsname}" data-values="${seedfile.variety}" name="variety" id="variety" style="margin-top: 5px;margin-bottom: 5px;">
...
<%-- 			</c:if> --%>
			...
			<c:if test="${!empty seedfile.level}">
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" type="text" placeholder="${seedfile.levels.belongsname}" data-values="${seedfile.level}" name="level"  id="level" style="margin-top: 5px;margin-bottom: 5px;">
			...
			<c:if test="${!empty seedfile.placeid}">
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" type="text" placeholder="${seedfile.plots.plotname}" data-values="${seedfile.placeid}" name="placeid"  id="placeid" style="margin-top: 5px;margin-bottom: 5px;">
...
<%-- 			</c:if> --%>
	...
	$("#rewarddate").calendar();
		...
		function submitinfo(){
			<c:if test="${!empty seedfile.variety}">
				var variety=$("#variety").data("values");
				if(variety==""){
					$.toptip('请选择品种', 'error');
					return false;
				}
			...
			<c:if test="${!empty seedfile.placeid}">
				var placeid=$("#placeid").data("values");
