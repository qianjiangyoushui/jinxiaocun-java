...
<body style="background-color: #FFFFFF">
	<div style="height: 50px; line-height: 50px; background: #f7f7f7; text-align: center; font-size: 16px; border-bottom: 1px solid #bdbbbc; position: relative">
		${client.clientname}
		<a href="${wechatPath}client/list.action" style="position: absolute; left: 10px; top: 8px">
			<img src="${wechatPath}icon/back.png" style="width: 20px" />
		</a>
	</div>
	<div style="margin-top: 5px;overflow:hidden">
		<a href="${wechatPath}saledafter/list.action?clientid=${client.guid}">
			<div  style="background-color: #FFA726;" class="center-left">
				<span style="color: #FFFFFF">售后服务信息</span>
			</div>
		</a>
		<a href="${wechatPath}sales/list.action?clientid=${client.guid}">
			<div style="background-color: #E84E40;" class="center-right">
				<span style="color: #FFFFFF">销售记录</span>
			</div>
		</a>
	</div>
	
	<div style="margin-top: 5px;overflow:hidden">
		<a href="${wechatPath}client/detail.action?clientid=${client.guid}">
			<div  style="background-color: #738FFE;" class="center-left">
				<span style="color: #FFFFFF">客户详细信息及维护</span>
			</div>
		</a>
	</div>
	<hr/>
