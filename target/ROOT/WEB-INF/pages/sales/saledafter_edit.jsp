...
<body>
	...
	<form action="${wechatPath}saledafter/update.action" method="post" id="formid">
		<input  type="hidden" id="guid" name="guid" value="${saledservice.guid }"/>
		<div class="weui-cells weui-cells_form" style="margin-top: 0px;">
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text"  value="${saledservice.batch }" data-values="${saledservice.salesid}"  name="records"  id="records" style="margin-top: 5px;margin-bottom: 5px;">
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" value="${saledservice.traintype }" name="traintype" id="traintype" style="margin-top: 5px;margin-bottom: 5px;">
				</div>
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" value="${saledservice.tlantdensity }" name="tlantdensity" id="tlantdensity" style="margin-top: 5px;margin-bottom: 5px;">
				</div>							
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd" style="float: right;margin-left: 50%">
					<input class="weui_switch"  type="checkbox" <c:if test='${saledservice.isdisinfect eq 1}'>checked='checked'</c:if>  name="isdisinfect"  id="isdisinfect" style="margin-top: 8px;margin-bottom: 5px;">
				</div>							
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd" style="float: right;margin-left: 50%">
					<input class="weui_switch"  type="checkbox"  <c:if test='${saledservice.isremoved eq 1}'>checked='checked'</c:if>  name="isremoved"  id="isremoved" style="margin-top: 8px;margin-bottom: 5px;">
				</div>							
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<textarea class="weui-textarea" name="rottenrate" id="rottenrate"  rows="2" style="margin-top: 5px; margin-bottom: 5px;border:solid 1px #E0E0E0; border-radius:10px; resize:none;">${saledservice.rottenrate }</textarea>
				</div>
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd" style="float: right;margin-left: 50%">
					<input class="weui_switch"  type="checkbox" <c:if test='${saledservice.ismedicine eq 1}'>checked='checked'</c:if> name="ismedicine"  id="ismedicine" style="margin-top: 8px;margin-bottom: 5px;">
				</div>							
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<textarea class="weui-textarea" name="medicinetype" id="medicinetype"  rows="2" style="margin-top: 5px; margin-bottom: 5px;border:solid 1px #E0E0E0; border-radius:10px; resize:none;">${saledservice.medicinetype }</textarea>
				</div>
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd" style="float: right;margin-left: 50%">
					<input class="weui_switch"  type="checkbox" <c:if test='${saledservice.isdisinfecte eq 1}'>checked='checked'</c:if> name="isdisinfecte"  id="isdisinfecte" style="margin-top: 8px;margin-bottom: 5px;">
				</div>							
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<textarea class="weui-textarea" name="disinfecttype" id="disinfecttype"  rows="2" style="margin-top: 5px; margin-bottom: 5px;border:solid 1px #E0E0E0; border-radius:10px; resize:none;">${saledservice.disinfecttype }</textarea>
				</div>
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<textarea class="weui-textarea" name="watering" id="watering"    rows="2" style="margin-top: 5px; margin-bottom: 5px;border:solid 1px #E0E0E0; border-radius:10px; resize:none;">${saledservice.watering}</textarea>
				</div>
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<textarea class="weui-textarea" name="manure" id="manure"  rows="2" style="margin-top: 5px; margin-bottom: 5px;border:solid 1px #E0E0E0; border-radius:10px; resize:none;">${saledservice.manure }</textarea>
				</div>
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<textarea class="weui-textarea" name="pests" id="pests"   rows="2" style="margin-top: 5px; margin-bottom: 5px;border:solid 1px #E0E0E0; border-radius:10px; resize:none;">${saledservice.pests}</textarea>
				</div>
			</div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text"  value="<fmt:formatDate value='${date}' pattern='yyyy-MM-dd'/>" readonly="readonly"  name="lastupdate" id="lastupdate" style="margin-top: 5px; margin-bottom: 5px;"/>
				</div>
			</div>
...
<!-- 			</div> -->
	...
	function uploadimg(src,date,type,desc){
		...
		function submitinfo(){
			...
			var records=$("#records").attr("data-values");
			if(records==""){
				$.toptip('选择销售记录', 'error');
				flag=false;
			}
...
// 				}
				...
				$.ajax({
					url : "${wechatPath}saledafter/update.action",
					type : "POST",
					async : false,
					dataType : 'json',
					data : {
