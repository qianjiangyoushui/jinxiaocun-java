...
<body style="background-color: #FFFFFF">
	...
	<form action="${wechatPath}upload/save.action" method="post">
		<c:choose>
		<c:when test="${sessionScope.user.depart.departid eq '3'}">
				...
				success : function(data) {
					...
					if(data.msg=='ok'){
						$.confirm("上传成功", function() {
							if(data.operate!=null&&data.operate!=""){
								window.location.href="${wechatPath}${url}?operate="+data.operate;
							}else{
