...
<body style="background-color: #FFFFFF">
	...
	<form action="${wechatPath}seedbed/save.action" method="post" id="formid">
		<div class="weui-cells weui-cells_form" style="margin-top: 0px;">
			<div class="weui-cell">
				<div class="weui-cell__hd">
					<label class="weui-label">组培室名称</label>
				</div>
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="请输入组培室名称"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="number" pattern="[0-9]*"
						placeholder="请输入可放置瓶苗个数" name="amount"
						id="amount" style="margin-top: 5px; margin-bottom: 5px;"/>
				</div>
			</div>
			<div class="weui-cell">
				<div class="weui-cell__hd">
					<label class="weui-label">组培室描述</label>
				</div>
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="请输入组培室描述"
	...
	function uploadimg(src,date,type,desc){
		...
		return imageid;
		  ...
		  $("#submitid").on("click",function(){
				...
				$.ajax({
					url : "${wechatPath}seedbed/save.action",
					type : "POST",
					async : false,
					dataType : 'json',
					data : {
					...
					success : function(data) {
						if(data.msg=='ok'){
							$.confirm("新增成功", function() {
								window.location.href="${wechatPath}seedbed/list.action";
						  }, function() {
