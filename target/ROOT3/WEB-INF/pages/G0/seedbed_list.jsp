...
<body>
	<div style="height: 50px; line-height: 50px; background: #f7f7f7; text-align: center; font-size: 16px; border-bottom: 1px solid #bdbbbc; position: relative">
		...
		<a href="${wechatPath}seedbed/add.action" style="position: absolute; right: 27px; top: 0px;">
			<img src="${wechatPath}icon/add.png" style="width: 20px" />
		</a>
		<a href="${wechatPath}seedbed/add.action" style="position: absolute; right: 10px; top: 15px; text-decoration: none; font-size: 12px; color: #333">新增苗床</a>
	</div>
		...
		function operate(seedbedid){
			$.actions({
				  actions: [{
				    text: "苗床详情",
				    onClick: function() {
				    	window.location.href='${wechatPath}seedbed/detail.action?seedbedid='+seedbedid+'&operate=2';
				    }
				  }
				  ,{
					    text: "修改苗床",
					    onClick: function() {
					    	window.location.href='${wechatPath}seedbed/edit.action?seedbedid='+seedbedid+'&operate=2';
					    }
					  }
				  ]
				});
