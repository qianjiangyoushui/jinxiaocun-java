		...
		<div class="weui-cells weui-cells_form" style="margin-top: 0px;">
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="请输入客户姓名"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" 
						placeholder="请输入联系方式" name="tlephone"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="number" placeholder="请输入种植面积（亩）"
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" type="text" placeholder="请选择地址"
		...
		return imageid;
	 	...
	 	$("#address").cityPicker({
		  ...
		  $("#submitid").on("click",function(){
				...
				$.showLoading();
				$.ajax({
					url : "${wechatPath}client/save.action",
					type : "POST",
					async : false,
					dataType : 'json',
					data : {
					...
					success : function(data) {
						...
						if(data.msg=='ok'){
							$.confirm("新增成功", function() {
								window.location.href="${wechatPath}client/list.action";
						  }, function() {
